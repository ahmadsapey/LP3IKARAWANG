...
<body class="bg-slate-50">
            ...
            <form action="<?php echo e(route('pendaftar.biodata.update')); ?>" method="POST" enctype="multipart/form-data">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
                <div>
                  ...
                  <input type="text" name="nama_ibu_kandung" class="w-full border border-slate-300 rounded-xl px-4 py-2.5 transition-all form-input-custom" placeholder="Contoh: Sri Wulandari" value="<?php echo e(old('nama_ibu_kandung', $pendaftar->nama_wali ?? '')); ?>">
                </div>
                <div>
                  <label class="block text-sm font-semibold text-slate-700 mb-2">Nama Ayah</label>
                  <input type="text" name="nama_ayah" class="w-full border border-slate-300 rounded-xl px-4 py-2.5 transition-all form-input-custom" placeholder="Contoh: Budi Santoso" value="<?php echo e(old('nama_ayah', $pendaftar->pekerjaan_wali ?? '')); ?>">
                </div>
                <div class="md:col-span-2">
  ...
  <footer class="mt-12 py-8 text-center text-slate-400 text-xs">
    &copy; <?php echo e(date('Y')); ?> LP3I Karawang. All rights reserved.
  </footer>

</body>
</html><?php /**PATH D:\Lp3i\LP3IKARAWANG\resources\views/pendaftar/biodata_edit.blade.php ENDPATH**/ ?>