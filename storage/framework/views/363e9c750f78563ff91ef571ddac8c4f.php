      ...
      <main>
        <div class="bg-white rounded-xl card-adv p-6">
          <div class="flex items-center justify-between">
            ...
            <div class="text-sm text-slate-500">Nomor NIPD: <strong class="text-slate-700"><?php echo e($pendaftar->nipd ?? '-'); ?></strong></div>
          </div>
          ...
          <form action="<?php echo e(route('pendaftar.biodata.update')); ?>" method="POST" enctype="multipart/form-data" class="mt-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input type="text" name="tempat_lahir" class="w-full border rounded px-3 py-2" value="<?php echo e(old('tempat_lahir', $pendaftar->tempat_lahir ?? '')); ?>">
              </div>
              <div>
              ...
              <div>
                ...
                <input type="text" name="angkatan" class="w-full border rounded px-3 py-2" value="<?php echo e(old('angkatan', $pendaftar->angkatan ?? '')); ?>">
              </div>
              ...
              <div>
                ...
                <input type="text" name="periode" class="w-full border rounded px-3 py-2" value="<?php echo e(old('periode', $pendaftar->periode ?? '')); ?>">
              </div>
              ...
              <div>
                ...
                <input type="tel" name="whatsapp_wali" class="w-full border rounded px-3 py-2" value="<?php echo e(old('whatsapp_wali', $pendaftar->whatsapp_wali ?? '')); ?>">
              </div>
              ...
              <div class="md:col-span-2">
                ...
                <?php if(!empty($pendaftar->photo_url) || !empty($pendaftar->foto)): ?>
                  <div class="mt-2"><img src="<?php echo e(asset(ltrim($pendaftar->foto ?? $pendaftar->photo_url,'/'))); ?>" alt="Preview" class="w-32 h-32 object-cover rounded-md border"></div>
                <?php endif; ?>
              </div>
