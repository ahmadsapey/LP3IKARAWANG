            ...
            <div class="nav-menu">
                ...
                <div class="mobile-only-links">
                    ...
                    <ul class="nav-links-mobile">
                        ...
                        <li><a href="<?php echo e(route('student')); ?>"><i class="fas fa-graduation-cap"></i> E | Student</a></li>
                        <li><a href="<?php echo e(route('akademik')); ?>"><i class="fas fa-book"></i> E | Akademik</a></li>
                        <li><a href="<?php echo e(route('lecture')); ?>"><i class="fas fa-chalkboard-teacher"></i> E | Lecture</a></li>
