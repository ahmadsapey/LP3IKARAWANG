...
<body>
    <div class="container">
        ...
        <div class="form-container">
            ...
            <form method="POST" action="<?php echo e(route('struktur-organisasi.update', $strukturOrganisasi)); ?>" enctype="multipart/form-data" class="elegant-form">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>

                <div class="form-group">
                    <label for="nama"><i class="fas fa-user"></i> Nama Lengkap *</label>
                    <input type="text" id="nama" name="nama" class="form-control" value="<?php echo e(old('nama', $strukturOrganisasi->nama)); ?>" required>
                </div>

                <div class="form-group">
                    <label for="role"><i class="fas fa-briefcase"></i> Role / Jabatan *</label>
                    <input type="text" id="role" name="role" class="form-control" value="<?php echo e(old('role', $strukturOrganisasi->role)); ?>" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="urutan" name="urutan" class="form-control" value="<?php echo e(old('urutan', $strukturOrganisasi->urutan)); ?>" min="0">
                ...
                <div class="form-group">
                    ...
                    <?php if($strukturOrganisasi->foto): ?>
                        <div class="current-photo">
                            <img src="<?php echo e(\App\Helpers\StoragePathHelper::url($strukturOrganisasi->foto)); ?>" alt="<?php echo e($strukturOrganisasi->nama); ?>">
                        </div>
                    <?php else: ?>
