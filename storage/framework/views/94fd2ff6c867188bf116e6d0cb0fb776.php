...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Career Tags */
        .career-tags { display: flex; flex-wrap: wrap; gap: 0.8rem; margin-top: 1rem;}
        .career-tag {
        ...
        /* Images */
        figure { margin: 0; overflow: hidden; border-radius: 16px; position: relative; height: 100%; min-height: 250px; }
        figure img {
            width: 100%;
            height: 100%;
            object-fit: cover;
    ...
    <div class="wrap">
        ...
        <div class="grid-2 animate-fade-up delay-1">
            ...
            <figure class="card" style="padding: 0; border: none;">
                <img src="<?php echo e(asset('storage/image/ASE.jpg')); ?>" alt="Program ASE" onerror="this.onerror=null;this.src='<?php echo e(asset('storage/image/ASE.png')); ?>'">
        ...
        <div class="animate-fade-up delay-2">
            ...
            <div class="grid-3">
                ...
                <figure class="card" style="padding: 0; border: none; grid-column: auto / span 2;">
                    <img src="<?php echo e(asset('storage/image/ASE2.jpg')); ?>" alt="Kegiatan akademik ASE" onerror="this.onerror=null;this.src='<?php echo e(asset('storage/image/ASE.png')); ?>'">
                    <figcaption>Kolaborasi mahasiswa dalam proyek dan studi kasus.</figcaption>
                </figure>
            </div>
        </div>

        <div class="grid-2 animate-fade-up delay-3">
            <div class="card">
            ...
            <figure class="card" style="padding: 0; border: none;">
                <img src="<?php echo e(asset('storage/image/ASE3.jpg')); ?>" alt="Aktivitas mahasiswa ASE" onerror="this.onerror=null;this.src='<?php echo e(asset('storage/image/ASE.png')); ?>'">
...
</html><?php /**PATH D:\Lp3i\LP3IKARAWANG\resources\views/ase.blade.php ENDPATH**/ ?>