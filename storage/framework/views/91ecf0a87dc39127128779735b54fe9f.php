  ...
  <div class="container">
    <div class="heading">
      <div>
        ...
        <div class="subtitle">Halo, <strong><?php echo e($calon->nama_mhs); ?></strong></div>
      </div>
      <a class="back-link" href="<?php echo e(route('pendaftar.dashboard')); ?>">← Kembali ke Dashboard</a>
    </div>

    <div class="card">
      <div class="info-summary">
        <span class="info-label">Total Tagihan</span>
        <span class="info-value">Rp <?php echo e(number_format($calon->payment_amount ?? 350000,0,',','.')); ?></span>
      </div>
      ...
      <?php else: ?>
        ...
        <form id="uploadForm" method="POST" action="<?php echo e(route('pendaftar.payment.upload')); ?>" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" name="account_name" required class="form-input" placeholder="Contoh: Ahmad Subarjo" value="<?php echo e(old('account_name')); ?>">
          </div>

          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
             <div class="form-group">
                <label class="form-label">Bank Asal</label>
                <input type="text" name="bank_origin" required class="form-input" placeholder="BCA / Mandiri / BRI" value="<?php echo e(old('bank_origin')); ?>">
              </div>
              <div class="form-group">
                <label class="form-label">Tanggal Transfer</label>
                <div id="transferDateDisplay" class="form-input readonly-box"><?php echo e(\Carbon\Carbon::now()->format('d M Y')); ?></div>
              </div>
          </div>
          ...
          <div class="btn-group">
            ...
            <a class="btn-outline" href="<?php echo e(route('pendaftar.dashboard')); ?>">Batal</a>
          </div>
        </form>
      <?php endif; ?>
    </div>
