  ...
  <div class="lp3i-footer-main">
    <div class="lp3i-footer-col logo-col">
      <div class="footer-logo-wrap">
           ...
           <div class="footer-logo-slogan">Cepat. Tepat. Kerja.</div>
       </div>
    </div>
    ...
    <div class="lp3i-footer-col address-col">
      ...
      <div class="footer-contact-item">
        ...
        <a href="mailto:karawang@lp3i.id">karawang@lp3i.id</a>
      </div>
      <div class="footer-contact-item">
        <i class="fab fa-instagram"></i> 
        <a href="https://www.instagram.com/lp3ikarawang" target="_blank">@lp3ikarawang</a>
      </div>
    </div>
  </div>
