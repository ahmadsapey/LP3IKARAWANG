<aside class="bg-white rounded-xl border p-5 shadow-sm lg:sticky lg:top-24 w-full">
  ...
  <div class="flex items-center gap-3 mb-5 border-b pb-4">
    ...
    <div class="overflow-hidden">
      ...
      <div class="font-bold text-slate-700 truncate"><?php echo e(Auth::user()->name ?? 'Pendaftar'); ?></div>
    </div>
  </div>
  ...
  <nav class="space-y-1.5 text-sm">
    ...
    ?>
    <a class="flex items-center gap-3 py-2 rounded transition-all <?php echo e($dashboardClass); ?>" href="<?php echo e(route('pendaftar.dashboard')); ?>">
      <svg class="w-4 h-4 <?php echo e($isDashboard ? 'text-[#004269]' : 'text-slate-400'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
      <span>Dashboard</span>
    </a>
    ...
    <?php
      ...
      $biodataClass = $isBiodata 
        ...
        : 'text-slate-600 hover:bg-slate-50 pl-3';
    ?>
    <a class="flex items-center gap-3 py-2 rounded transition-all <?php echo e($biodataClass); ?>" href="<?php echo e(route('pendaftar.biodata.show')); ?>">
      <svg class="w-4 h-4 <?php echo e($isBiodata ? 'text-[#004269]' : 'text-slate-400'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
      <span>Biodata</span>
    </a>
    ...
    ?>
    <details class="group details-acc" <?php echo e($isAccount ? 'open' : ''); ?>>
      <summary class="flex items-center gap-3 px-3 py-2 rounded hover:bg-slate-50 cursor-pointer text-slate-600">
        ...
        <span class="font-medium <?php echo e($isAccount ? 'text-[#004269] font-bold' : ''); ?>">Akun Saya</span>
      ...
      <div class="pl-7 mt-1.5 space-y-1 border-l-2 border-slate-100 ml-4">
        ...
        ?>
        <a href="<?php echo e(route('pendaftar.akun.email')); ?>" class="block py-1.5 rounded transition-all <?php echo e($isEmail ? 'text-[#004269] font-bold' : 'text-slate-500 hover:text-slate-800'); ?>">Email</a>
        <a href="<?php echo e(route('pendaftar.akun.password')); ?>" class="block py-1.5 rounded transition-all <?php echo e($isPassword ? 'text-[#004269] font-bold' : 'text-slate-500 hover:text-slate-800'); ?>">Password</a>
        <a href="<?php echo e(route('pendaftar.akun.phone')); ?>" class="block py-1.5 rounded transition-all <?php echo e($isPhone ? 'text-[#004269] font-bold' : 'text-slate-500 hover:text-slate-800'); ?>">No. Handphone</a>
        <a href="<?php echo e(route('pendaftar.akun.whatsapp')); ?>" class="block py-1.5 rounded transition-all <?php echo e($isWhatsapp ? 'text-[#004269] font-bold' : 'text-slate-500 hover:text-slate-800'); ?>">No. WhatsApp</a>
      </div>
    </details>
  </nav>
</aside>
<?php /**PATH D:\Lp3i\LP3IKARAWANG\resources\views/partials/sidebar_pendaftar.blade.php ENDPATH**/ ?>