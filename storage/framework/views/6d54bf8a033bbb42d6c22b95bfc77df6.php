    ...
    <div class="video-container">
        ...
        <div class="video-mockup">
            ...
            <div class="video-preview-wrapper" id="video-preview-wrapper">
                ...
                <video id="lp3i-local-video" class="video-local-player" controls playsinline preload="metadata" poster="<?php echo e(asset('storage/image/gedung.jpeg')); ?>" style="display:none; position:absolute; inset:0; width:100%; height:100%; object-fit:cover; background:#000;">
                    <source src="<?php echo e(asset('storage/image/Video.mp4')); ?>" type="video/mp4">
  ...
  <div class="study-container">
    ...
    <div class="study-image-group">
      ...
      <div class="study-image-wrap secondary-image">
        <img src="<?php echo e(asset('storage/image/ASE2.JPG')); ?>" alt="AIS Program LP3I Karawang" class="study-image">
      </div>
    </div>
