...
<main class="main-container">
    <section class="profile-section">
        <div class="avatar-wrapper" data-aos="zoom-in" data-aos-delay="100">
            <div class="avatar-box">
                <img src="<?php echo e($bmImage); ?>" alt="<?php echo e($bmName); ?>">
            </div>
        </div>
        <div class="leader-info">
            <div class="title-badge" data-aos="fade-right" data-aos-delay="350"><?php echo e($bmTitle); ?></div>
            <h1 data-aos="fade-left" data-aos-delay="500"><?php echo e($bmName); ?></h1>
        </div>
    </section>
    ...
    <section class="content-card" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="closing-signature" data-aos="fade-up" data-aos-delay="1300">
            ...
            <p>Salam hangat,</p>
            <br>
            <strong><?php echo e($bmName); ?></strong><br>
            <span><?php echo e($bmRole); ?></span>
        </div>
    </section>
</main>
...
</html><?php /**PATH D:\Lp3i\LP3IKARAWANG\resources\views/sambutan.blade.php ENDPATH**/ ?>