    ...
    <div class="wrap">
        ...
        <div class="grid-2 animate-fade-up delay-1">
            ...
            <figure class="card" style="padding: 0; border: none;">
                <img src="<?php echo e(asset('storage/image/OAA.jpg')); ?>" alt="Program OAA" onerror="this.onerror=null;this.src='<?php echo e(asset('storage/image/OAA.png')); ?>'">
        ...
        <div class="animate-fade-up delay-2">
            ...
            <div class="grid-3">
                ...
                <figure class="card" style="padding: 0; border: none; grid-column: auto / span 2;">
                    <img src="<?php echo e(asset('storage/image/OAA2.jpg')); ?>" alt="Kegiatan akademik OAA" onerror="this.onerror=null;this.src='<?php echo e(asset('storage/image/OAA.png')); ?>'">
        ...
        <div class="grid-2 animate-fade-up delay-3">
            ...
            <figure class="card" style="padding: 0; border: none;">
                <img src="<?php echo e(asset('storage/image/OAA3.jpg')); ?>" alt="Aktivitas mahasiswa OAA" onerror="this.onerror=null;this.src='<?php echo e(asset('storage/image/OAA.png')); ?>'">
...
</html><?php /**PATH D:\Lp3i\LP3IKARAWANG\resources\views/oaa.blade.php ENDPATH**/ ?>