            ...
            <?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              ...
              <div class="relative flex items-center gap-4 pb-4 last:pb-0">
                <?php if(!$loop->last): ?>
                  ...
                  ?>
                  <div class="absolute left-5 top-10 bottom-0 w-0.5 <?php echo e($lineColor); ?>"></div>
                <?php endif; ?>
                <div class="relative z-10 flex items-center justify-center rounded-full w-10 h-10 <?php echo e($dotBg); ?> <?php echo e($dotTxt); ?> shrink-0">
                  <?php if($isCompleted): ?>
                ...
                <div class="text-sm font-semibold text-slate-700"><?php echo e($s['label']); ?></div>
              </div>
            ...
            <?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <div class="flex items-center flex-1 last:flex-none">
                <div class="flex flex-col items-center w-24 sm:w-32">
                  ...
                  <div class="flex items-center justify-center rounded-full w-10 h-10 <?php echo e($dotBg); ?> <?php echo e($dotTxt); ?> shrink-0">
                    <?php if($isCompleted): ?>
                      <svg class="w-5 h-5 text-white" viewBox="0 0 24 24" fill="none"><path d="M20 6L9 17l-5-5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                    <?php else: ?>
                      <span class="text-sm font-semibold"><?php echo e($i + 1); ?></span>
                  ...
                  <div class="mt-3 text-xs text-slate-600 text-center font-medium"><?php echo e($s['label']); ?></div>
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div class="lg:col-span-2 bg-white rounded-xl border p-5 shadow-sm">
            ...
            <dl class="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-slate-700">
              <div class="p-3 bg-slate-50 rounded"><dt class="text-xs text-slate-400">Nomor NIPD</dt><dd class="font-medium mt-1"><?php echo e($calon?->nipd ?? '-'); ?></dd></div>
