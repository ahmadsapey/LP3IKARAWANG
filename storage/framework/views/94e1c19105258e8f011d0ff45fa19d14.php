      ...
      <div class="grid-2">
        <div>
          ...
          <div style="display:grid;grid-template-columns:140px 1fr;gap:.5rem .75rem;align-items:start">
            ...
            <div class="label">No HP</div><div><?php echo e($m->no_tlp ?? '-'); ?></div>
            <div class="label">Bidang Keahlian</div><div><?php echo e(\App\Helpers\JurusanHelper::getNamaLengkap($m->id_program_studi ?? null)); ?></div>
          ...
          <form method="POST" action="<?php echo e(route('marketing.pendaftar.note', $m->id_mahasiswa)); ?>">
            <?php echo csrf_field(); ?>
        ...
        <aside>
          <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:.6rem">
            ...
            <div style="font-size:.85rem;color:var(--muted)">ID: <?php echo e($m->id_mahasiswa); ?></div>
          </div>

          <div class="doc-list">
            <?php if(!empty($m->ktp_path)): ?>
              <div class="doc-file"><div style="flex:1">KTP / Kartu Pelajar</div><a href="<?php echo e(route('marketing.pendaftar.ktp', $m->id_mahasiswa)); ?>" class="doc-btn">Download</a></div>
            <?php endif; ?>
            <?php if(!empty($m->ijazah_path)): ?>
              <div class="doc-file"><div style="flex:1">Ijazah</div><a href="<?php echo e(route('marketing.pendaftar.ijazah', $m->id_mahasiswa)); ?>" class="doc-btn">Download</a></div>
            <?php endif; ?>
            <?php if(!empty($m->akte_kelahiran_path)): ?>
              <div class="doc-file"><div style="flex:1">Akte Kelahiran</div><a href="<?php echo e(route('marketing.pendaftar.akte', $m->id_mahasiswa)); ?>" class="doc-btn">Download</a></div>
            <?php endif; ?>
            <?php if(!empty($m->surat_sudah_bekerja_path)): ?>
              <div class="doc-file"><div style="flex:1">Surat Keterangan Bekerja</div><a href="<?php echo e(route('marketing.pendaftar.surat_bekerja', $m->id_mahasiswa)); ?>" class="doc-btn">Download</a></div>
            <?php endif; ?>
