@php
    ...
    $vision = !empty($settings['vision']) ? $settings['vision'] : 'Menjadi lembaga pendidikan vokasi terbaik yang mencetak lulusan berkualitas, berakhlak, adaptif, dan kompeten.';
    $missionRaw = !empty($settings['mission']) ? $settings['mission'] : "Menjadi lembaga pendidikan vokasi terbaik di wilayah PURWASUKA.\nMencetak lulusan yang beretika, sopan, dan santun.\nMembentuk pribadi berjiwa wirausaha untuk kemajuan bangsa.\nMembangun jaringan terluas di Jawa Barat.\nMenciptakan SDM yang berakhlak, adaptif, and kompeten.\nMemberikan kesejahteraan dan rasa tentram bagi seluruh keluarga besar LP3I.";
    ...
    <section class="section-padding container-custom story-section">
        <div class="story-grid">
            ...
            <div class="story-image">
                <img src="{{ asset('storage/image/gedung.jpeg') }}" alt="Kampus LP3I Karawang">
            </div>
        </div>
    </section>
