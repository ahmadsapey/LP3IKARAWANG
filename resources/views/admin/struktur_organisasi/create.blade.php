...
<body>
    <div class="container">
        ...
        <div class="form-container">
            ...
            <form method="POST" action="{{ route('struktur-organisasi.store') }}" enctype="multipart/form-data" class="elegant-form">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="role" name="role" class="form-control" placeholder="Contoh: Branch Manager" value="{{ old('role') }}" required>
                </div>
                ...
                <div class="form-group">
                    <label for="foto"><i class="fas fa-image"></i> Foto Profil</label>
