...
<body>
    <div class="container">
        ...
        <div class="form-container">
            <h1><i class="fas fa-edit"></i> Edit Penempatan</h1>

            <form action="{{ route('admin.penempatan.update', $penempatan) }}" method="post" enctype="multipart/form-data" class="elegant-form">
                @csrf
                @method('PUT')

                <div class="form-group">
                    <label for="title"><i class="fas fa-heading"></i> Judul / Nama Item *</label>
                    <input type="text" id="title" name="title" class="form-control" value="{{ old('title', $penempatan->title) }}" required>
                </div>

                <div class="form-group">
                    <label for="description"><i class="fas fa-align-left"></i> Deskripsi / Keterangan *</label>
                    <textarea id="description" name="description" class="form-control" rows="5" required>{{ old('description', $penempatan->description) }}</textarea>
                </div>

                <div class="form-group">
                    <label for="source_url"><i class="fas fa-link"></i> URL Sumber (opsional)</label>
                    <input type="text" id="source_url" name="source_url" class="form-control" value="{{ old('source_url', $penempatan->source_url) }}">
                </div>
                ...
                <div class="form-group">
                    <label for="image"><i class="fas fa-upload"></i> Ganti Gambar (Max 2MB)</label>
