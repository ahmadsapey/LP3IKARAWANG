        ...
        <div class="container">
            ...
            <div class="header-contact">
                ...
                <div class="contact-item">
                    ...
                    <div class="contact-text">
                        <strong>college@lp3iglobal.com</strong>
                        ...
                        <li>
                            <div class="mobile-brosur-group">
                                ...
                                <div class="mobile-brosur-links">
                                    <a href="{{ asset('storage/docs/Brosur Reguler 2026 V2.pdf') }}" download><i class="fas fa-download"></i> Reguler</a>
                                    <a href="{{ asset('storage/docs/Brosur Karyawan 2026-2027 V2.pdf') }}" download><i class="fas fa-download"></i> Karyawan</a>
                                </div>
                            </div>
                        </li>
                    </ul>
