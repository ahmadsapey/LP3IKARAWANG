...
<body>
    ...
    <div class="wrap">
        ...
        <div class="grid-2 competence-grid">
            ...
            <figure>
                <img src="{{ asset('storage/image/AIS.jpg') }}" alt="Program AIS" onerror="this.onerror=null;this.src='{{ asset('storage/image/AIS.png') }}'">
        ...
        <div class="cpl-section">
            ...
            <div class="grid-3 cpl-grid">
                ...
                <figure style="grid-column: auto / span 2;">
                    <img src="{{ asset('storage/image/AIS2.jpg') }}" alt="Kegiatan akademik AIS" onerror="this.onerror=null;this.src='{{ asset('storage/image/AIS.png') }}'">
        ...
        <div class="career-section-single" style="margin-bottom: 4rem;">
            <div class="card">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // 4. Career section
            gsap.from('.career-section-single', {
                scrollTrigger: {
                    trigger: '.career-section-single',
                    start: 'top 80%',
                    toggleActions: 'play none none none'
                },
                y: 40,
