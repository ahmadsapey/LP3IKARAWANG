    ...
    <div class="wrap">
        ...
        <div class="grid-2 animate-fade-up delay-1">
            ...
            <figure class="card" style="padding: 0; border: none;">
                <img src="{{ asset('storage/image/ASE.jpg') }}" alt="Program ASE" onerror="this.onerror=null;this.src='{{ asset('storage/image/ASE.png') }}'">
        ...
        <div class="animate-fade-up delay-2">
            ...
            <div class="grid-3">
                ...
                <figure class="card" style="padding: 0; border: none; grid-column: auto / span 2;">
                    <img src="{{ asset('storage/image/ASE2.jpg') }}" alt="Kegiatan akademik ASE" onerror="this.onerror=null;this.src='{{ asset('storage/image/ASE.png') }}'">
        ...
        <div class="grid-2 animate-fade-up delay-3">
            ...
            <figure class="card" style="padding: 0; border: none;">
                <img src="{{ asset('storage/image/ASE3.jpg') }}" alt="Aktivitas mahasiswa ASE" onerror="this.onerror=null;this.src='{{ asset('storage/image/ASE.png') }}'">
